...
package com.github.shareme.gwsmaterialdesignportfolioapps.library.appcompatext.widget;
...
import com.github.shareme.gwsmaterialdesignportfolioapps.library.appcompatext.drawable.PlaceholderDrawable;
...
public class CircleImageView extends ImageView {
  ...
  public static Bitmap getBitmapFromDrawable(Drawable drawable) {
    ...
    if (drawable instanceof BitmapDrawable) {
      Timber.w(LOG_TAG, "For better performance consider using setImageBitmap() instead!");
